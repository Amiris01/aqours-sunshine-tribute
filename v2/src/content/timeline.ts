...
export interface Milestone {
  ...
  date: string
  /** A big stage moment (dome lives, Kōhaku, the finale) rather than an announcement. */
  live?: boolean
  text: Localized
}
...
export const timeline: Milestone[] = [
  ...
  { date: '2018.11', live: true, text: { en: '4th LoveLive! at Tokyo Dome.', ja: '東京ドームで4thライブ。' } },
  { date: '2018.12', live: true, text: { en: 'Special performance on NHK Kōhaku Uta Gassen.', ja: 'NHK紅白歌合戦に出演。' } },
  { date: '2019.01', text: { en: 'The School Idol Movie: Over the Rainbow.', ja: '劇場版『Over the Rainbow』公開。' } },
  { date: '2019', live: true, text: { en: 'First Love Live! Asia tour; 5th LoveLive! at MetLife Dome.', ja: 'シリーズ初のアジアツアー、メットライフドームで5thライブ。' } },
  { date: '2023.07', text: { en: 'Spin-off anime Yohane the Parhelion.', ja: 'スピンオフアニメ『幻日のヨハネ』放送開始。' } },
  { date: '2025.06', live: true, text: { en: 'Finale LoveLive! ~Eikyuu stage~ at Belluna Dome.', ja: 'ベルーナドームで「Finale LoveLive! ～永久stage～」。' } },
]
