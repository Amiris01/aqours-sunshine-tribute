...
export function HeroFallback({ sea = true }: { sea?: boolean }) {
  return (
    <div data-testid="hero-fallback" className="absolute inset-0" aria-hidden="true">
      <div className="absolute inset-0 bg-[linear-gradient(180deg,#030814_0%,#071a31_40%,#0f3a5c_57%,#06101f_100%)]" />
      ...
      {sea && (
        <>
          <div className="absolute inset-x-0 top-[57%] bottom-0 bg-[linear-gradient(180deg,#0f3a5c_0%,#071a31_40%,#06101f_100%)]" />
